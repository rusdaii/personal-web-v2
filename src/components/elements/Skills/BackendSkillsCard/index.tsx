...
import { SiDocker, SiExpress, SiNodedotjs, SiPostgresql } from 'react-icons/si';
    ...
    <div className="col-span-6 sm:col-span-12">
      ...
      >
        ...
        <div className="w-full flex flex-col items-center justify-center mt-4">
          ...
          <ul
            className="grid items-center justify-center grid-cols-2 gap-10 md:grid-cols-2 
            lg:grid-cols-2 xs:grid-cols-1"
          >
